...
function wax(){
    ...
    if(world.wax.kult === true){
        ...
        numberChange("cult", "priests", 1, "blue", "");
        terrorCrafts.mass.unlocked = true;
            document.getElementById('massWrap').style.display='block';
        eventBox('images/eventImages/mummy.jpg', "The Mummy.", "T'yog, frozen for thousands of years, stands in a corner, arms raised to amuse the foolish. Transmuted with the scroll which bears his name, T'yog offers service as a Priest capable of specialized rituals and the means to contact his patron. (+1 Priest, Black Mass in TerrorCrafts, Shub-Niggurath in Sacrarium)");
    }
